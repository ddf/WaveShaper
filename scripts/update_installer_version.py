...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=WaveShaper Demo Installer\n"
      else:
        line="OutputBaseFilename=WaveShaper Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the WaveShaper Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the WaveShaper installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=WaveShaper Demo installer\n"
     else:
       line="SetupWindowTitle=WaveShaper installer\n"
