...
def main():
  ...
  plistpath = scriptpath + "/resources/WaveShaper-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/WaveShaper-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/WaveShaper-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/WaveShaper-OSXAPP-Info.plist"
...
#  plistpath = scriptpath + "/resources/WaveShaper-RTAS-Info.plist"
...
#  plistpath = scriptpath + "/resources/WaveShaper-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/WaveShaper-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/WaveShaper.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/WaveShaper.iss",inplace=1):
